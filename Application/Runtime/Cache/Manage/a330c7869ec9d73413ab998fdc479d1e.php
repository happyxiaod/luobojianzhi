...
<script>
    ...
    var SEL_PATH = "/index.php/Manage/Setting/pageRegionCity";
    var ACT_PATH = "/index.php/Manage/Setting/pageRegionCity";
</script>
</head>
<body>
        ...
        <div class="fragbox">
            <div style="margin-top:10px">
                <div class="pull-left">
                    ...
                    <a href="/index.php/Manage/Setting/pageRegionCity?often=1" class="btn btn-primary">常用城市列表</a>
                </div>
                    ...
                    <table class="table text-center mtop1">
                        ...
                        <?php if(is_array($cityList)): $i = 0; $__LIST__ = $cityList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-sm delCity">删除</button>
                                    <a href="/index.php/Manage/Setting/pageSaveCity?id=<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-sm">修改</a>
                                    <?php if($vo["often"] == 1): ?><button class="btn btn-warning btn-sm cancelOftenCity">取消常用</button>
                                        <?php else: ?>
                                        <button class="btn btn-success btn-sm setOftenCity">设为常用</button><?php endif; ?>
                                </td>
