...
<script>
    ...
    var SEL_PATH = "/index.php/Manage/Setting/pageAddSchool";
    var ACT_PATH = "/index.php/Manage/Setting/pageAddSchool";
</script>
</head>
<body>
            ...
            <div style="margin-top:10px">
                <div class="form-inline" gt-model="school">
                    <select class="form-control" gt-isparam="province">
                        ...
                        <?php if(is_array($provinceList)): $i = 0; $__LIST__ = $provinceList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" gt-menu-click="loadCityList2"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
            ...
            <div class="row middle-content">
                <div class="col-md-10">
                    <table class="table text-center mtop1">
                        ...
                        <tbody>
                        <?php if(is_array($schoollist)): $i = 0; $__LIST__ = $schoollist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
...
<script>
    jQuery(document).ready(function($) {
        bindClick();
        $("#navSettingAddSchool").addClass("nav-two-active"); //更改导航样式
    });
</script>