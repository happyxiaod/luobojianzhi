...
<script>
    ...
    var CON_PATH = "/luoboNew/index.php/Manage/Audit";
    var SEL_PATH = "/luoboNew/index.php/Manage/Audit/pageSchool";
    var ACT_PATH = "/luoboNew/index.php/Manage/Audit/pageSchool";
</script>	
</head>
<body>
			...
			<div class="col-md-10">
				<table class="table text-center mtop1">
					...
					<?php if(is_array($userSchoolList)): $i = 0; $__LIST__ = $userSchoolList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<button class="audit-thumbnail" gt-btn-click="audit-thumbnail" popup-src="<?php echo ($vo["idobverse"]); ?>">正面</button>
								<button class="audit-thumbnail" gt-btn-click="audit-thumbnail" popup-src="<?php echo ($vo["idreverse"]); ?>">反面</button>
							</td>
							<td>
							...
							<td>
								<a href="/luoboNew/index.php/Manage/Audit/pageSchoolInfo?id=<?php echo ($vo["id"]); ?>" target="_blank" class="btn btn-primary btn-sm">查看详情</a>
							</td>
...
<script>
	jQuery(document).ready(function($) {
		bindClick();
		$("#navAuditSchool").addClass("nav-two-active"); //更改导航样式
	});
</script>