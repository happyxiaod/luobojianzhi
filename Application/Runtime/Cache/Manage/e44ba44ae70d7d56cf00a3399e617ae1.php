...
<script>
    ...
    var SEL_PATH = "/luoboNew/manage.php/Member/pageNotCheckedSeeker";
    var ACT_PATH = "/luoboNew/manage.php/Member/pageNotCheckedSeeker";
</script>
</head>
<body>
    ...
    <?php if(($currentnav) == "微信活动"): ?><li class="nav-two" id="navWeixinActivity">
        ...
        <li class="nav-two" id="navWeixinActivity">
            ...
            <div class="content col-md-10">
                ...
                <!-- TODO 换成当前的导航菜单内容-->
                    <span class="mleft2">
                <a href="/luoboNew/manage.php/Member/exportExcel?params=check" class="btn btn-sm btn-primary">导出所有数据</a>
                ...
                <div class="row fragbox">
                    ...
                    <div class="col-md-11">
                        <table class="table text-center mtop1 table-bordered">
                            ...
                            <tbody>
                            <?php if(is_array($notUserSeekerList)): $i = 0; $__LIST__ = $notUserSeekerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
