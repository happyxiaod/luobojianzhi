...
<script>
    ...
    var CON_PATH = "/luoboNew/index.php/Manage/Setting";
    var SEL_PATH = "/luoboNew/index.php/Manage/Setting/pageScroll";
    var ACT_PATH = "/luoboNew/index.php/Manage/Setting/pageScroll";
</script>
</head>
<body>
    ...
    <div class="content col-md-10">
        ...
        <div class="fragbox">
            <div style="margin-top:10px">
                <button class="btn btn-nopad" gt-btn-click="fragAddScroll">添加轮播图</button>
            </div>
            <!-- 右边具体内容 -->
            <div class="row">
                <div class="col-md-10">
                    <table class="table text-center mtop1">
                        ...
                        <tbody>
                        <?php if(is_array($scrolllist)): $i = 0; $__LIST__ = $scrolllist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($vo["key"]); ?></td>
                                <td>
                                    <input type="hidden" value="<?php echo ($vo["id"]); ?>" name="id"/>
                                    <button class="btn btn-success btn-sm" popup-src="/luoboNew/Uploads/<?php echo ($vo["value"]); ?>" gt-btn-click="audit-thumbnail">查看缩略图</button>
                                    <button class="btn btn-danger btn-sm" gt-btn-click="delScroll">删除</button>
                                </td>
...
<script>
    jQuery(document).ready(function($) {
        bindClick();
        $("#navSettingScroll").addClass("nav-two-active"); //更改导航样式
    });
</script>