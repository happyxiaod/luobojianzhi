...
<script>
    ...
    var CON_PATH = "/luoboNew/index.php/Manage/Member";
    var SEL_PATH = "/luoboNew/index.php/Manage/Member/pageSeeker";
    var ACT_PATH = "/luoboNew/index.php/Manage/Member/pageSeeker";
</script>	
</head>
<body>
...
<?php if($_SESSION['user']['adminname']== 'luobo'): ?><div class="row" style="background: #c3e7ff;">
    ...
    <div class="content col-md-10">
        ...
        <div  style="background:#f4f4f4;height:36px;line-height:36px;border-bottom:1px solid #ddd">
            <div class="col-md-3">
                <a href="/luoboNew/index.php/Manage/Member/exportExcel?params=all" class="btn btn-sm btn-primary">导出数据</a><span>(默认导出当前日期5000条数据)</span>
            </div>
            <div class="col-md-1">
            ...
            <div class="col-md-11">
                <table class="table text-center mtop1 table-bordered">
                    ...
                    <?php if(is_array($userSeekerList)): $i = 0; $__LIST__ = $userSeekerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["realname"]); ?>
                                <!--如果是没有审核的-->
                                <?php if(($vo['state']) == "2"): ?><small>
                            ...
                            <td>
                                ...
                                <a href="/luoboNew/index.php/Manage/Audit/pageSeekerInfo?id=<?php echo ($vo["id"]); ?>" target="_blank" class="label label-primary">
                                    查看详情
                                </a>
                            </td>
...
<script>
    $(document).ready(function () {
        ...
        $("#search").on('click', '', function (event) {
            ...
            if (param!="") {
                location.href="/luoboNew/index.php/Manage/Member/pageSeeker?params="+param;
            }else{
                alert("没有输入有效的搜索内容");
            }
        });
        ...
        $("#exportMonth").on('click', '', function (event) {
            ...
            if (month!="") {
                location.href="/luoboNew/index.php/Manage/Member/exportExcel?params=all&month="+month;
            }else{
                alert("请选择月份");
            }
        });
...
<script>
	jQuery(document).ready(function($) {
		bindClick();
		$("#navMemberSeeker").addClass("nav-two-active"); //更改导航样式
	});
</script>