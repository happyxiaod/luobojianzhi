...
<script>
    ...
    var CON_PATH = "/luoboNew/manage.php/Setting";
    var SEL_PATH = "/luoboNew/manage.php/Setting/pageJobType";
    var ACT_PATH = "/luoboNew/manage.php/Setting/pageJobType";
</script>
</head>
<body>
...
<div class="row" style="background: #c3e7ff;">
    ...
    <div class="row" id="daohang">
        <ul id="nav">
            ...
            <li><a href="/luoboNew/manage.php/Feedback/pageFeedback">
                ...
                意见反馈</a></li>
            <li><a href="/luoboNew/manage.php/Weixin/activity">
                <span class="glyphicon glyphicon-comment"></span>
    ...
    <div class="content col-md-10">
        ...
        <!-- TODO 换成当前的导航菜单内容-->
			<span class="mleft2">
				添加兼职的行业及职位分类，以供企业发布兼职时选择
			</span>
        </div>
        <div class="fragbox">
            <div style="margin-top:10px">
                <button class="btn btn-nopad" gt-btn-click="fraglevel1">添加行业分类</button>
                <button class="btn btn-nopad" gt-btn-click="fraglevel2">添加职位分类</button>
            </div>
            <!-- 右边具体内容 -->
