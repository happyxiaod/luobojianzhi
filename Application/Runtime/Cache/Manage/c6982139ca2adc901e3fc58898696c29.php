...
<script>
    ...
    var SEL_PATH = "/luoboNew/manage.php/Member/pageCheckedCompany";
    var ACT_PATH = "/luoboNew/manage.php/Member/pageCheckedCompany";
</script>	
</head>
<body>
...
<?php if($_SESSION['user']['adminname']== 'luobo'): ?><div class="row" style="background: #c3e7ff;">
    ...
    <div class="content col-md-10">
        ...
        <div class="row" style="background:#f4f4f4;height:36px;line-height:36px;border-bottom:1px solid #ddd">
            <!-- TODO 换成当前的导航菜单内容-->
			<span class="mleft2">
                <a href="/luoboNew/manage.php/Member/exportExcel?params=company"
            ...
            <div class="col-md-11">
                <table class="table text-center mtop1 table-bordered">
                    ...
                    <?php if(is_array($userCompanyList)): $i = 0; $__LIST__ = $userCompanyList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo (mb_substr($vo["address"],0,15,'utf-8')); ?></td>
                            ...
                            <td>
                                <?php if(!empty($vo['idobverse'])){ echo('
                                    <button class="audit-thumbnail" gt-btn-click="audit-thumbnail"
                                            popup-src="/luoboNew/Uploads/ids/'.$vo['idobverse'].'">证件照
                                    </button>
...
<script>
    ...
    $("#search").on('click', '', function (event) {
        ...
        if (param!="") {
            location.href="/luoboNew/manage.php/Member/pageCompany?params="+param;
        }else{
            alert("没有输入有效的搜索内容");
        }
    });
...
<script>
	jQuery(document).ready(function($) {
		bindClick();
		$("#navCheckedCompany").addClass("nav-two-active"); //更改导航样式
	});
</script>