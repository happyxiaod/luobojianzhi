...
<script>
    ...
    var SEL_PATH = "/manage.php/Position/pageSchool";
    var ACT_PATH = "/manage.php/Position/pageSchool";
</script>	
</head>
<body>
...
<?php if($_SESSION['user']['adminname']== 'luobo'): ?><div class="row" style="background: #c3e7ff;">
	...
	<div class="content col-md-10">
		...
		<div class="row middle row-content fragbox">
			<div class="col-md-2">
				<button gt-btn-click="frag-school-publish-list" class="btn btn-orange form-control mtop2 load-right-data">发布记录</button>
				<button gt-btn-click="frag-school-recruit-list" class="btn btn-gray form-control mtop1 load-right-data">招聘成功</button>
			</div>
