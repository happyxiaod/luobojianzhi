...
<script>
    ...
    var CON_PATH = "/luoboNew/manage.php/Position";
    var SEL_PATH = "/luoboNew/manage.php/Position/pageGood";
    var ACT_PATH = "/luoboNew/manage.php/Position/pageGood";
</script>	
</head>
<body>
...
<?php if($_SESSION['user']['adminname']== 'luobo'): ?><div class="row" style="background: #c3e7ff;">
	...
	<div class="content col-md-10">
		...
		<!-- 右边具体内容 -->
		<div class="row middle row-content fragbox">
			<div class="col-md-2">
				<button gt-btn-click="frag-seeker-deliver-list" class="btn btn-orange form-control mtop2 load-right-data">投递记录</button>
				<button gt-btn-click="frag-seeker-succeed-list" class="btn btn-gray form-control mtop1 load-right-data">成功记录</button>
			</div>
...
<script>
	jQuery(document).ready(function($) {
		bindClick();
		loadPage($(".load-table-page"), CON_PATH+"/fragSeekerDeliverList");
		$("#navPositionSeeker").addClass("nav-two-active"); //更改导航样式
	});
</script>