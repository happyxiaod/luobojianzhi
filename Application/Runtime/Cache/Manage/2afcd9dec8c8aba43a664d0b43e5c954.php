...
<script>
    ...
    var SEL_PATH = "/luoboNew/manage.php/Weixin/weal";
    var ACT_PATH = "/luoboNew/manage.php/Weixin/weal";
</script>	
</head>
<body>
...
<?php if($_SESSION['user']['adminname']== 'luobo'): ?><div class="row" style="background: #c3e7ff;">
    ...
    <div class="content col-md-10">
        ...
        <div class="" style="background:#f4f4f4;height:36px;line-height:36px;border-bottom:1px solid #ddd">
            <div class="col-md-2">
                <a href="/luoboNew/manage.php/Weixin/exportExcel?params=all" class="btn btn-sm btn-primary">导出所有数据</a>
            </div>
        ...
        <div class="row fragbox">
            ...
            <div class="col-md-11">
                <table class="table text-center mtop1 table-bordered">
                    ...
                    <tbody>
                    <?php if(is_array($userWealList)): $i = 0; $__LIST__ = $userWealList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          
                            <td><?php echo ($vo["realname"]); ?> </td>
                            <td><?php echo ($vo["phone"]); ?></td>
                            <td><?php echo ($vo["birthday"]); ?></td>
                            <td><?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["county"]); echo ($vo["address"]); ?></td>
                            <td><?php echo ($vo["createtime"]); ?></td>
                            <td><?php echo ($vo["state"]); ?></td>
                            <td><?php echo ($vo["zipcode"]); ?></td>
                            <td>
                                <input type="hidden" value="<?php echo ($vo["id"]); ?>" name="id"/>
                                <a href="/luoboNew/manage.php/Audit/pageWealInfo?id=<?php echo ($vo["id"]); ?>" target="_blank" class="label label-primary">
                                    查看详情
                                </a>
...
<script>
    $(document).ready(function () {
        ...
        $("#search").on('click', '', function (event) {
            ...
            if (param!="") {
                location.href="/luoboNew/manage.php/Weixin/weal?params="+param;
            }else{
                alert("没有输入有效的搜索内容");
            }
        });
