<?php if (!defined('THINK_PATH')) exit();?><table class="table text-center mtop1 table-hover table-bordered table-striped">
	<thead>
		<tr>
	...
	<tbody>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr gt-block-click="frag-seeker-deliver">
				<input type="hidden" value="<?php echo ($vo["id"]); ?>" name="id"/>
				<td name="name"><?php echo ($vo["realname"]); ?></td>
