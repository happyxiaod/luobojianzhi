	...
	<table class="table text-center mtop1 table-bordered">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php echo ($vo["jobinfo"]); ?></td>
					<td><?php echo (date('Y-m-d',$vo["reporttime"])); ?></td>
					<td><?php echo ($vo["complaint"]); ?></td>
					<!-- <td><?php echo ($vo["status"]); ?></td>
					<td><input type="hidden" value="<?php echo ($vo["id"]); ?>" name="id"/>
								<button class="btn btn-success btn-sm" gt-btn-click="com-job-top">拉黑</button>
