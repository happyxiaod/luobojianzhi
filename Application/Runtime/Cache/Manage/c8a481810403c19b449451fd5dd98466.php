<?php if (!defined('THINK_PATH')) exit();?><table class="table text-center mtop1 table-hover">
	<thead>
	<tr>
	...
	<?php if(is_array($userSeekerList)): $i = 0; $__LIST__ = $userSeekerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			<td style="line-height: 30px;"><?php echo ($vo["username"]); ?></td>
			...
			<!--<td>
                <button class="audit-thumbnail" gt-btn-click="audit-thumbnail" popup-src="/luoboNew/Uploads/<?php echo ($vo["idobverse"]); ?>">正面</button>
                <button class="audit-thumbnail" gt-btn-click="audit-thumbnail" popup-src="/luoboNew/Uploads/<?php echo ($vo["idreverse"]); ?>">反面</button>
            </td>-->
			<td>
