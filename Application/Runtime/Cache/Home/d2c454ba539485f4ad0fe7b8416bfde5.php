...
<script>
    ...
    var SEL_PATH = "/index.php/Home/Company/pageManage";
    var ACT_PATH = "/index.php/Home/Company/pageManage";
</script>
</head>
<body>
...
<div id="person">
        ...
        <div class="per_t">
            <div class="per_nav">
 <a href="/index.php/Home/Company/pageManage/pageManage">首页</a> > <a href="/index.php/Home/Company/pageManage"><?php echo ($top_nav); ?></a>
</div>
<div class="per_dal">
...
<?php elseif($_SESSION['user']['type']== 'school'): ?>
    <ul class="per_nav">
            ...
            <div class="per_r_dal">             
                <h4 class="font-orange">数据中心</h4>
                <table class="manage">
                    <tr>
                        <th width="220"></th>
                        <th width="220">新增报名</th>
                        <th width="220">新增职位</th>
                        <th>新增评论</th>
                    </tr>
                    <tr>
                        <td>今天</td>
                        <td><?php echo ($dayApplycount); ?></td>
                        <td><?php echo ($dayjobcount); ?></td>
                        <td><?php echo ($dayCommentcount); ?></td>
                    </tr>
                    <tr>
                        <td>本周</td>
                        <td><?php echo ($weekApplycount); ?></td>
                        <td><?php echo ($weekjobcount); ?></td>
                        <td><?php echo ($weekCommentcount); ?></td>
                    </tr>
                    <tr>
                        <td>上周</td>
                        <td><?php echo ($lastweekApplycount); ?></td>
                        <td><?php echo ($lastweekjobcount); ?></td>
                        <td><?php echo ($lastweekCommentcount); ?></td>
                    </tr>
                    <tr>
                        <td>本月</td>
                        <td><?php echo ($monthApplycount); ?></td>
                        <td><?php echo ($monthjobcount); ?></td>
                        <td><?php echo ($monthCommentcount); ?></td>
                    </tr>
                </table>
