...
<script>
    ...
    var CON_PATH = "/luoboFinal/index.php/Home/Feed";
    var SEL_PATH = "/luoboFinal/index.php/Home/Feed/pageFeedback";
    var ACT_PATH = "/luoboFinal/index.php/Home/Feed/pageFeedback";
</script>
</head>
<body>
...
<?php elseif($_SESSION['user']['type']== 'school'): ?>
    <ul class="per_nav">
            ...
            <div class="per_r_dal">
                <h4 class="font-orange">意见反馈</h4>
                <textarea name="" id="" cols="30" rows="10"  vali="custom[^([\u4E00-\u9FA5A-Za-z\s]{2,200})$]" maxlength="200" class="feed-textarea"></textarea>
                <input type="button" value="提交" class="btn_feed_submit"  gt-btn-click="feedback"/>
            </div>
        </div>
        <!-- 个人中心end -->
    </div>
    ...
    <div id="footer">
        <div class="footer">
            <dl>
                ...
                <dd><a href="/luoboFinal/index.php/Home/Article/index?nav=AboutRadish">萝卜兼职</a></dd>
                <dd><a href="/luoboFinal/index.php/Home/Feed/pageFeedback">在线反馈</a></dd>
            </dl>
            <div class="line"></div>
            <dl>
                <dt>帮助中心</dt>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $("#pageFeedback").removeClass("cur").addClass("cur");
    });
</script>