...
<link rel="stylesheet" href="/luoboFinal/Public/new/css/user2.css"/>
...
<script>
    ...
    var SEL_PATH = "/luoboFinal/index.php/Home/User/pageUploadCertificates";
    var ACT_PATH = "/luoboFinal/index.php/Home/User/pageUploadCertificates";
</script>
</head>
<body>
    <!-- 头部内容 -->
                ...
                <div class="photo_up">
                    <ul>
                        <li>
                            ...
                            <div class="file">
                                <b>选择图片</b>
                                <input type="file" multiple="" accept="image/*" class="fileElem" onchange="handleFiles(this)">
                            </div>
                            <div id="fileList"></div>
                        ...
                        <li>
                            ...
                            <div class="file">
                                <b>选择图片</b>
                                <input type="file" multiple="" accept="image/*" class="fileElem" onchange="handleFiles1(this)">
                            </div>
                        ...
                        <li>
                            ...
                            <div class="file">
                                <b>选择图片</b>
                                <input type="file" multiple="" accept="image/*" class="fileElem" onchange="handleFiles2(this)">
                            </div>
