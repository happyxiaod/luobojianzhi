...
<script>
    ...
    var SEL_PATH = "/index.php/Home/Company/pageProve.html";
    var ACT_PATH = "/index.php/Home/Company/pageProve";
</script>
</head>
<body>
...
<script type="text/javascript">
    ...
    <!-- 主体内容 -->
        ...
        <div class="per_t">
            <div class="per_nav">
 <a href="/index.php/Home/Company/pageProve/pageManage">首页</a> > <a href="/index.php/Home/Company/pageProve.html"><?php echo ($top_nav); ?></a>
</div>
<div class="per_dal">
                ...
                <div class="per_cont" gt-model="saveProve">
                    ...
                    <div class="per_company" style="overflow:hidden;height:auto;">
                        ...
                        <div class="person_r">
                            ...
                            <img class="reg-id-img" id="pic_logo" src="/Uploads/<?php echo ($user["logo"]); ?>" />
                            <input type="hidden" gt-islabel="公司logo"/>
                            <input type="file" gt-isparam="logo"/>              
                        </div>
                        <div class="person_r">
                            <div class="papers">营业执照</div>
                            <img  class="reg-id-img" id="pic_orgauth" src="/Uploads/<?php echo ($user["orgauth"]); ?>" />
                            <input type="hidden" gt-islabel="营业执照"/>
                            <input type="file" gt-isparam="orgauth"/>           
                        </div>  
                        <div class="person_r">
                            <div class="papers">负责人身份证</div>
                            <img  class="reg-id-img" id="pic_idobverse" src="/Uploads/<?php echo ($user["idobverse"]); ?>" />
