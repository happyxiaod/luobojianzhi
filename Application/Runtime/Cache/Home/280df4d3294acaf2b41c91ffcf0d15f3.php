...
<script>
    ...
    var SEL_PATH = "/luoboFinal/index.php/Home/User/pageEditMyCenter";
    var ACT_PATH = "/luoboFinal/index.php/Home/User/pageEditMyCenter";
</script>
                   ...
                   <label  id="phoneWrong"></label>
                    ...
                    <div style="overflow:hidden;height:auto;">
                        ...
                        <div class="person_r">
                            ...
                            <img class="reg-id-img" src="/luoboFinal/Uploads/<?php echo ($user["idobverse"]); ?>" alt="" />
                            <input type="hidden" gt-islabel="证件正面"/>
                            <input type="file" gt-isparam="idobverse"/>         
                        </div>
                        <div class="person_r">
                            <div class="papers">背面</div>
                            <img class="reg-id-img" src="/luoboFinal/Uploads/<?php echo ($user["idreverse"]); ?>" alt="" />
                    ...
                    <input type="button" value="立即确认" class="btn_save" gt-btn-click="editMyInfo"/>
                </div>
            </div>
        </div>
        <!-- 个人中心end -->
