...
<script>
    ...
    var SEL_PATH = "/index.php/Home/Loan/startLoan";
    var ACT_PATH = "/index.php/Home/Loan/startLoan";
</script>
	<style>
		.lend_total {
    margin: 0 auto;
			...
			<div class="per_r_dal">
				...
				<div class="lend">
					<div class="lend_total">
						<span>可申请总额(元)</span>
						<b>5000.00</b>
						<a href="/index.php/Home/User/pageAuthentication">点击提升额度</a>
					</div>
					<div class="lend_txt">
						<span>资金用途：</span>
					...
					<!-- <a href="/index.php/Home/User/" class="btn_feed_submit" style="width: 50px">下一步</a> -->
					<a href="/index.php/Home/User/pageMyloan1" class="btn_feed_submit" style="width: 50px">下一步</a>
